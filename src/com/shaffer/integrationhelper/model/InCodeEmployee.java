...
public class InCodeEmployee implements Serializable {
	...
	public String toString() {
		return "InCodeEmployee [employeeId=" + employeeId + ", payrollNumber=" + payrollNumber + ", employeeNumber="
				+ employeeNumber + ", fullName=" + fullName + ", lastName=" + lastName + ", firstName=" + firstName
				+ ", mi=" + mi + ", address1=" + address1 + ", address2=" + address2 + ", city=" + city + ", State="
				+ State + ", zipCode=" + zipCode + ", SSN=" + SSN + ", payCycle=" + payCycle + ", otherCycle="
				+ otherCycle + ", filingStatus=" + filingStatus + ", status=" + status + ", payType=" + payType
				+ ", scheduledHours=" + scheduledHours + ", annualHours=" + annualHours + ", dependants=" + dependants
				+ ", dependentsState=" + dependentsState + ", ficaStatus=" + ficaStatus + ", homeState=" + homeState
				+ ", workState=" + workState + ", federalExempt=" + federalExempt + ", federalFixedWitholding="
				+ federalFixedWitholding + ", additionalFederalWitholding=" + additionalFederalWitholding
				+ ", stateExempt=" + stateExempt + ", stateFixedWitholding=" + stateFixedWitholding
				+ ", additionalStateWitholding=" + additionalStateWitholding + ", stateExemptAmount="
				+ stateExemptAmount + ", stateTaxTable=" + stateTaxTable + ", witholdingPercent=" + witholdingPercent
				+ ", estimatedCheck=" + estimatedCheck + ", EICStatus=" + EICStatus + ", maritialStatus="
				+ maritialStatus + ", rateClass=" + rateClass + ", longevityCode=" + longevityCode + ", title=" + title
				+ ", department=" + department + ", fullPartTime=" + fullPartTime + ", employeeType=" + employeeType
				+ ", birthDate=" + birthDate + ", sex=" + sex + ", race=" + race + ", creditUnion=" + creditUnion
				+ ", phoneNumber=" + phoneNumber + ", lastIncrease=" + lastIncrease + ", hireDate=" + hireDate
				+ ", terminationDate=" + terminationDate + ", longevityDate=" + longevityDate + ", leaveDate="
				+ leaveDate + ", serviceDate=" + serviceDate + ", EE04Category=" + EE04Category + ", retirementCode="
				+ retirementCode + ", emergencyContact=" + emergencyContact + ", emergencyRelation=" + emergencyRelation
				+ ", emergencyPhone=" + emergencyPhone + ", emergencyAddress=" + emergencyAddress + ", emergencyCSZ="
				+ emergencyCSZ + ", terminationCode=" + terminationCode + ", militaryCode=" + militaryCode
				+ ", veteranCode=" + veteranCode + ", disabilityCode=" + disabilityCode + ", I9Flag=" + I9Flag
				+ ", disabledVeteran=" + disabledVeteran + ", daysWorked=" + daysWorked + ", hoursPerDay=" + hoursPerDay
				+ ", stateEmployementDate=" + stateEmployementDate + ", lastPhysicalDate=" + lastPhysicalDate
				+ ", nextPhysicalDate=" + nextPhysicalDate + ", drugTestDate=" + drugTestDate + ", cobraDate="
				+ cobraDate + ", driversLicense=" + driversLicense + ", driversLicenseState=" + driversLicenseState
				+ ", driversLicenseExpire=" + driversLicenseExpire + ", driversLicenseType=" + driversLicenseType
				+ ", deceased=" + deceased + ", childCare=" + childCare + ", drugTestGroup=" + drugTestGroup
				+ ", unlistedPhone=" + unlistedPhone + ", annualPay=" + annualPay + ", workScheduleCode="
				+ workScheduleCode + ", reviewDate=" + reviewDate + "]" + System.lineSeparator();
	}

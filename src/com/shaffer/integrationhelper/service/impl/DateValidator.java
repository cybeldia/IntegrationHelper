...
public class DateValidator {
	...
	public static boolean isValidDate(InCodeEmployee employee, String dateFormat, JTextArea errorsTextArea) {
		...
		// SDF setLenient doesn't recognize when trailing characters are off - changed
		// to Java 8 TemporalAccessor
		...
		try {
			...
			String error = "Birthday is formatted incorrectly for employee: " + employee.getLastName() + ". "
					+ "Format is currently: " + employee.getBirthDate() + System.lineSeparator();
